...
current_NN = Residual_CNN(config.REG_CONST, config.LEARNING_RATE, (22,) + env.grid_shape, env.action_size,
                          config.HIDDEN_CNN_LAYERS)
best_NN = Residual_CNN(config.REG_CONST, config.LEARNING_RATE, (22,) + env.grid_shape, env.action_size,
                       config.HIDDEN_CNN_LAYERS)
...
while 1:
    ...
    lg.logger_main.info('Iteration: %d', iteration)
    lg.logger_main.info('Memory: %d', len(memory.ltmemory))
